...
const Comp3 = class extends React.Component {
  componentDidMount() {
    console.log(
      `Comp3 componentDidMount -> ${this.props.n} / ${this.props.m} = ${
        +this.props.n / +this.props.m
      }`
    );
    if (+this.props.m === 0) {
  ...
  render() {
    ...
    return (
      <>
        ...
        <div>
          props.children (inside Comp3 render()) -> {this.props.children}
        </div>
      </>
    );
  }
